<?php if(!empty($errors)): ?>
  ...
  <div class="mb-3">
    ...
    <input type="text" required value="<?php echo $title?>" name="title" class="form-control">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" required step=".01" value="<?php echo $price?>" class="form-control" name="price">
  </div>
  <div class="mb-3">
